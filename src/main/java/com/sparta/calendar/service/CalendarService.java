...
public class CalendarService {
    ...
    private static void getPicture(MultipartFile picture, CalendarPicture calendarPicture) {
        try {
            ...
            calendarPicture.setData( picture.getBytes() );
            calendarPicture.setExtension( picture.getContentType() );
            calendarPicture.setPicturename( picture.getOriginalFilename() );
            calendarPicture.setSize( (int) picture.getSize() );
